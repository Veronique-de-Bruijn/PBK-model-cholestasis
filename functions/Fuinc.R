...
f.Fuinc<-function(method.Clint, frac.unionized, frac.ionized.acid, frac.ionized.base, logD, logP, conc.enzymes.Clint, bound.unbound){
  #hepatocytes (Kilford et al., 2008)
  if (method.Clint == "hep" & frac.unionized >= 0.95 || method.Clint == "hep" & frac.ionized.acid >= 0.95 & bound.unbound=="bound"){
