...
f.BP <- function(ionization,frac.ionized.acid, frac.ionized.base) {
  if(ionization=="monoproticAcid" | ionization == "zwitterionic" & frac.ionized.acid >0.1 & frac.ionized.base<0.1){
    BP <- 0.55
  }
  else {
    BP <- 1
